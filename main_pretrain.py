...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # train the network
        scores, queue = train(args, train_loader, model, optimizer, epoch, lr_schedule, queue)
...
def train(args, train_loader, model, optimizer, epoch, lr_schedule, queue):
    ...
    for it, (inputs, gridq, gridk) in enumerate(train_loader):
        ...
        with jt.no_grad():
            ...
            # w = jt.nn.functional.normalize(w, dim=1, p=2)
