...
def getOption():
    ...
    parser.add_argument("--img_size", default=256, type=int, help="the optimizer for finetuning")
    ...
    parser.add_argument("--sam_path", type=str, default=None, help="the path to generated sam features")
    ...
    parser.add_argument("--seed", type=int, default=1208, help="seed")
