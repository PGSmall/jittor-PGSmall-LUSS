...
class SamAutomaticMaskGenerator:
    ...
    def _process_batch(
        ...
        in_points = jt.array(transformed_points).stop_grad()
        ...
        data = MaskData(
            ...
            points=jt.array(points.repeat(masks.shape[1], axis=0)).stop_grad(),
        )
        del masks
    ...
    def postprocess_small_regions(
        ...
        for rle in mask_data["rles"]:
            ...
            new_masks.append(jt.array(mask).stop_grad().unsqueeze(0))
