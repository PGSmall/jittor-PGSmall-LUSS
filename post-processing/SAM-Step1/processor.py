...
from merge.max_iou_imp2_ori import MaxIoU_IMP2_ori
...
class Processor:
    def __init__(self, params, num_cls=51):
        self.method = params.method
        method_dict = {
            'max_iou': MaxIoU,
            'max_iou_imp': MaxIoU_IMP,
            'max_iou_imp2': MaxIoU_IMP2,
            'max_iou_imp2_ori': MaxIoU_IMP2_ori,
        ...
        # self.save_path = './processed_mask'
        self.save_path = './post-processing/SAM-Step1/processed_mask'
    ...
    def generate_merged_masks(self):
        def process_file(filename, save_path, sam_path, merger):
            ...
            if os.path.isfile(save_path + f"/{name}.png"):
                return
            predict = np.array(Image.open(filename.path))[:, :, 0]
